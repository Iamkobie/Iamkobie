...
![banner](https://readme-typing-svg.herokuapp.com?font=Orbitron&size=35&duration=3000&pause=1000&color=00FF00&center=true&vCenter=true&width=900&height=100&lines=KOBIE+%7C+CYBERSECURITY+%2B+IoT;SECURING+THE+FUTURE;ONE+LINE+OF+CODE+AT+A+TIME)
...
```
💻 4th-Year IT Student | Philippines
🔐 Aspiring Cybersecurity / SOC Analyst  
⚙️  IoT Enthusiast | Embedded Systems Developer
🚀 Dual Stack: Security + Hardware Integration
```
...
```
The best security professionals understand BOTH offense and defense.
That's why I'm combining cybersecurity with embedded systems —
to build hardware that's not just powerful, but SECURE at its core.

"Stay curious. Stay secure. Stay hungry." 🚀
```
...
![Visitors](https://komarev.com/ghpvc/?username=Iamkobie&color=00FF00&style=flat-square&label=PROFILE+VIEWS)
...
> ls -la success/
total: UNLIMITED
drwxr-xr-x  Kobie  Kobie  june  6 2026  .
```
</div>
